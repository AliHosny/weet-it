...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    ...
    <!--helperfiles -->
      <script src="../Scripts/HelperScripts/Interaction_Driver3.js" type="text/javascript"></script>
      <script src="../Scripts/HelperScripts/renderer.js" type="text/javascript"></script>
      <script src="../Scripts/HelperScripts/ArborJSDriver3.js" type="text/javascript"></script>
      <script src="../Scripts/HelperScripts/main5.js" type="text/javascript"></script>     
</asp:Content>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="uppperBox">
        ...
        <button id="upperPreviewButton" class="upperButtons"onclick="return upperCompareButtonClicked();">Preview</button>
    ...
    <div id="resultbox" class="resultbox" style="width:1200px;" runat="server">
