...
namespace ObjectsRelationFactory
{
    class ObjectsRelationManager
    {
        ...
        public bool generateQueries(string object1, string object2, int maxDistance=5, int limit=50, List<string> ignoredObjects = null, List<string> ignoredProperties = null, int avoidCycles = 1)
        {
